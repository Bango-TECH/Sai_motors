...
const Tablefour = () => {
    ...
    useEffect(() => {
        axios.get("https://sai-motors-backend.vercel.app/four/get-image")
            .then(res => {
    ...
    function handledelete(UniqueID){
        axios.delete(`https://sai-motors-backend.vercel.app/four/delet1/${UniqueID}`)
        .then(res => {
            console.log(res.data);
    ...
    return (
        <Container fluid>
            ...
            <h6 style={{ padding: "10px" }}>
                <span style={{ color: "white", backgroundColor: "#272829", borderStyle: 'ridge', borderWidth: '5px', borderRadius: "30px", padding: "15px 20px", textDecoration: "none" }}>Four Wheeler / फोर व्हिलर 🚗</span>
            </h6><br />
